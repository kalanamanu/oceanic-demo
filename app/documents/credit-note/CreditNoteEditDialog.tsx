...
export default function CreditNoteEditDialog({
  open,
  onOpenChange,
  document,
}: Props) {
  ...
  // Load and populate document data into form fields on modal opening
  React.useEffect(() => {
    if (open && document) {
      ...
      reset({
        ...
        crnNo: data.crnNo || document.reference_no || "",
        ...
        items: data.items || [{ description: "", quantity: 1, unit_price: 0 }],
        approvedBy: data.approvedBy || "",
      });
    }
  }, [open, document, reset]);

  /* ================= RUNTIME TOTAL CALCULATION ================= */
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-h-[92vh] overflow-y-auto sm:max-w-5xl p-6 sm:p-8">
        <DialogHeader className="pb-4 border-b">
          ...
          <DialogDescription>
            Modify document records, line items, and parameters below.
          </DialogDescription>
        </DialogHeader>
