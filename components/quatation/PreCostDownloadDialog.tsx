...
export function PreCostDownloadDialog({
  ...
  const handleDownload = async () => {
    ...
    try {
        ...
        documentData: [
          {
            ...
            // flags for backend rendering
            show_discount: options.showDiscount,
            show_additional_charges: options.showAdditionalCharges,
      ...
      // 2. Poll (STRICT: 3 attempts, 2s interval)
      ...
      if (!job.result?.fileName) {
        throw new Error("File not generated by server");
      }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md rounded-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Choose options before generating document
          </DialogDescription>
        </DialogHeader>
